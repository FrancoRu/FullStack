        ...
        <div className="text col-xl-8 col-lg-8 col-md-9 col-sm-10">
          ...
          <div>
            <p className="text-body">
              You are now in an environment designed to facilitate task
              management in the style of Kanban. This system allows you to
              create projects and assign tasks to each one, providing effective
              control and efficient management of the timelines associated with
              each project.
            </p>
          </div>
          <div>
          ...
          <div>
            <p className="text-body">
              ...
              efficient application that will make the management of your
              projects and tasks smoother and more productive. We hope you enjoy
              using this tool to optimize your organization and productivity!
            </p>
          </div>
        </div>
      </div>
